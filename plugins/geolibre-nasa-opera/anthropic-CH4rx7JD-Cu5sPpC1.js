import { a as ModelThrottledError, c as createEmptyUsage, d as encodeBase64, g as resolveConfigMetadata, h as normalizeError, i as Model, l as defaultMaxTokensWarningMessage, m as logger, r as MODEL_DEFAULTS, t as ContextWindowOverflowError, u as defaultModelWarningMessage, y as warnOnce } from "./GeoAgentControl-BK8Q6PEC-QtqA2iOY.js";
//#region node_modules/maplibre-gl-geoagent/dist/anthropic-CH4rx7JD.js
...
var multipartFormRequestOptions = async (opts, fetch2, stripFilenames = true) => {
	return {
		...opts,
		body: await createForm(opts.body, fetch2, stripFilenames)
	};
};
	...
	*/
	create(params, options) {
		...
		return this._client.post("/v1/environments?beta=true", {
			body,
			...options,
			headers: buildHeaders([{ "anthropic-beta": [...betas ?? [], "managed-agents-2026-04-01"].toString() }, options == null ? void 0 : options.headers])
		});
	}
	/**
	...
	*/
	list(params = {}, options) {
		...
		return this._client.getAPIList("/v1/files?beta=true", Page, {
			query,
			...options,
			headers: buildHeaders([{ "anthropic-beta": [...betas ?? [], "files-api-2025-04-14"].toString() }, options == null ? void 0 : options.headers])
		});
	}
	/**
	* Delete File
...
var Models$1 = class Models extends APIResource {
	/**
	...
	*/
	retrieve(modelID, params = {}, options) {
		...
		return this._client.get(path`/v1/models/${modelID}?beta=true`, {
			...options,
			headers: buildHeaders([{ ...(betas == null ? void 0 : betas.toString()) != null ? { "anthropic-beta": betas == null ? void 0 : betas.toString() } : void 0 }, options == null ? void 0 : options.headers])
		});
	}
	/**
	...
	*/
	create(params, options) {
		...
		return this._client.post("/v1/user_profiles?beta=true", {
			body,
			...options,
			headers: buildHeaders([{ "anthropic-beta": [...betas ?? [], "user-profiles-2026-03-24"].toString() }, options == null ? void 0 : options.headers])
		});
	}
	/**
	* Get User Profile
...
var Versions$1 = class Versions extends APIResource {
	/**
	* List Agent Versions
	*
	* @example
...
var Batches$1 = class Batches extends APIResource {
	/**
	...
	*/
	create(params, options) {
		...
		return this._client.post("/v1/messages/batches?beta=true", {
			body,
			...options,
			headers: buildHeaders([{ "anthropic-beta": [...betas ?? [], "message-batches-2024-09-24"].toString() }, options == null ? void 0 : options.headers])
		});
	}
	/**
...
function parseBetaOutputFormat(params, content) {
	const outputFormat = getOutputFormat$1(params);
	if ((outputFormat == null ? void 0 : outputFormat.type) !== "json_schema") return null;
	try {
...
var BetaMessageStream = class BetaMessageStream {
	...
	*/
	...
	_emit(event, ...args) {
		...
		if (event === "abort") {
			const error = args[0];
			if (!__classPrivateFieldGet(this, _BetaMessageStream_catchingPromiseCreated, "f") && !(listeners == null ? void 0 : listeners.length)) Promise.reject(error);
	...
	[(_BetaMessageStream_currentMessageSnapshot = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_params = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_connectedPromise = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_resolveConnectedPromise = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_rejectConnectedPromise = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_endPromise = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_resolveEndPromise = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_rejectEndPromise = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_listeners = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_ended = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_errored = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_aborted = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_catchingPromiseCreated = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_response = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_request_id = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_logger = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_handleError = /* @__PURE__ */ new WeakMap(), _BetaMessageStream_instances = /* @__PURE__ */ new WeakSet(), _BetaMessageStream_getFinalMessage = function _BetaMessageStream_getFinalMessage2() {
		...
		switch (event.type) {
			...
			case "content_block_delta": {
				...
				switch (event.delta.type) {
					case "text_delta":
						if ((snapshotContent == null ? void 0 : snapshotContent.type) === "text") snapshot.content[event.index] = {
							...snapshotContent,
					...
					case "input_json_delta":
						...
						break;
					case "thinking_delta":
						if ((snapshotContent == null ? void 0 : snapshotContent.type) === "thinking") snapshot.content[event.index] = {
							...snapshotContent,
					...
					case "signature_delta":
						...
						break;
					case "compaction_delta":
						if ((snapshotContent == null ? void 0 : snapshotContent.type) === "compaction") snapshot.content[event.index] = {
							...snapshotContent,
...
var BetaToolRunner = class {
	constructor(client, params, options) {
		...
		if ((_a2 = params.compactionControl) == null ? void 0 : _a2.enabled) console.warn("Anthropic: The `compactionControl` parameter is deprecated and will be removed in a future version. Use server-side compaction instead by passing `edits: [{ type: \"compact_20260112\" }]` in the params passed to `toolRunner()`. See https://platform.claude.com/docs/en/build-with-claude/compaction");
	}
	async *[(_BetaToolRunner_consumed = /* @__PURE__ */ new WeakMap(), _BetaToolRunner_mutated = /* @__PURE__ */ new WeakMap(), _BetaToolRunner_state = /* @__PURE__ */ new WeakMap(), _BetaToolRunner_options = /* @__PURE__ */ new WeakMap(), _BetaToolRunner_message = /* @__PURE__ */ new WeakMap(), _BetaToolRunner_toolResponse = /* @__PURE__ */ new WeakMap(), _BetaToolRunner_completion = /* @__PURE__ */ new WeakMap(), _BetaToolRunner_iterationCount = /* @__PURE__ */ new WeakMap(), _BetaToolRunner_instances = /* @__PURE__ */ new WeakSet(), _BetaToolRunner_checkAndCompact = async function _BetaToolRunner_checkAndCompact2() {
		...
		if (((_a2 = response.content[0]) == null ? void 0 : _a2.type) !== "text") throw new AnthropicError("Expected text response for compaction");
	...
	setRequestOptions(optionsOrMutator) {
		if (typeof optionsOrMutator === "function") __classPrivateFieldSet(this, _BetaToolRunner_options, optionsOrMutator(__classPrivateFieldGet(this, _BetaToolRunner_options, "f")));
...
Please migrate to a newer model. Visit https://docs.anthropic.com/en/docs/resources/model-deprecations for more information.`);
	...
	*/
	parse(params, options) {
		options = {
			...options,
			headers: buildHeaders([{ "anthropic-beta": [...params.betas ?? [], "structured-outputs-2025-12-15"].toString() }, options == null ? void 0 : options.headers])
		};
	...
	*/
	countTokens(params, options) {
		...
		return this._client.post("/v1/messages/count_tokens?beta=true", {
			body,
			...options,
			headers: buildHeaders([{ "anthropic-beta": [...betas ?? [], "token-counting-2024-11-01"].toString() }, options == null ? void 0 : options.headers])
		});
	}
...
function transformOutputFormat(params) {
	...
	if ((_a2 = params.output_config) == null ? void 0 : _a2.format) throw new AnthropicError("Both output_format and output_config.format were provided. Please use only output_config.format (output_format is deprecated).");
	...
	*/
	create(skillID, params = {}, options) {
		...
		return this._client.post(path`/v1/skills/${skillID}/versions?beta=true`, multipartFormRequestOptions({
			body,
			...options,
			headers: buildHeaders([{ "anthropic-beta": [...betas ?? [], "skills-2025-10-02"].toString() }, options == null ? void 0 : options.headers])
		}, this._client));
	}
	/**
	* Get Skill Version
...
var MessageStream = class MessageStream {
	...
	*/
	...
	_emit(event, ...args) {
		...
		if (event === "abort") {
			const error = args[0];
			if (!__classPrivateFieldGet(this, _MessageStream_catchingPromiseCreated, "f") && !(listeners == null ? void 0 : listeners.length)) Promise.reject(error);
...
Anthropic.Beta = Beta;
var CONTEXT_WINDOW_OVERFLOW_ERRORS = [
	"prompt is too long",
	"max_tokens exceeded",
	"input too long"
];
var TEXT_FILE_FORMATS = [
	"txt",
	"md",
	"markdown",
	"csv",
...
var AnthropicModel = class extends Model {
	constructor(options) {
		...
		if (modelConfig.modelId === void 0) warnOnce(logger, defaultModelWarningMessage(MODEL_DEFAULTS.anthropic.modelId));
		if (modelConfig.maxTokens === void 0) warnOnce(logger, defaultMaxTokensWarningMessage(MODEL_DEFAULTS.anthropic.maxTokens));
		if (client) this._client = client;
		else {
			const hasEnvKey = typeof process !== "undefined" && typeof process.env !== "undefined" && process.env.ANTHROPIC_API_KEY;
			if (!apiKey && !hasEnvKey) throw new Error("Anthropic API key is required. Provide it via the 'apiKey' option or set the ANTHROPIC_API_KEY environment variable.");
			this._client = new Anthropic({
				...apiKey ? { apiKey } : {},
				...clientConfig,
				defaultHeaders: {
					...clientConfig == null ? void 0 : clientConfig.defaultHeaders,
	...
	*/
		...
		try {
			...
			for await (const event of stream) switch (event.type) {
				case "message_start": {
					...
					if (rawUsage.cache_creation_input_tokens !== void 0) usage.cacheWriteInputTokens = rawUsage.cache_creation_input_tokens;
					if (rawUsage.cache_read_input_tokens !== void 0) usage.cacheReadInputTokens = rawUsage.cache_read_input_tokens;
					yield {
				...
				case "content_block_start":
					if (event.content_block.type === "tool_use") yield {
						...
						if (event.content_block.thinking) yield {
						...
						yield { type: "modelContentBlockStartEvent" };
						if (event.content_block.type === "text" && event.content_block.text) yield {
							type: "modelContentBlockDeltaEvent",
							delta: {
								type: "textDelta",
				...
				case "content_block_delta":
					...
					else if (event.delta.type === "input_json_delta") yield {
						type: "modelContentBlockDeltaEvent",
						delta: {
					...
					else if (event.delta.type === "thinking_delta") yield {
						type: "modelContentBlockDeltaEvent",
						delta: {
							type: "reasoningContentDelta",
					...
					else if (event.delta.type === "signature_delta") yield {
						type: "modelContentBlockDeltaEvent",
						delta: {
							type: "reasoningContentDelta",
							signature: event.delta.signature
				...
				case "message_delta":
					...
					if (event.delta.stop_reason) stopReason = this._mapStopReason(event.delta.stop_reason);
					break;
				case "message_stop":
			...
			if (CONTEXT_WINDOW_OVERFLOW_ERRORS.some((msg) => error.message.includes(msg))) throw new ContextWindowOverflowError(error.message);
			const err = unknownError;
			if (err.status === 429) throw new ModelThrottledError(error.message ?? "Request was throttled by the model provider", { cause: err });
			throw error;
		}
	}
	_formatRequest(messages, options) {
		...
		if (options == null ? void 0 : options.systemPrompt) {
			if (typeof options.systemPrompt === "string") request.system = options.systemPrompt;
				...
				for (let i = 0; i < options.systemPrompt.length; i++) {
					...
					if (block.type === "textBlock") {
						...
						const cacheControl = (nextBlock == null ? void 0 : nextBlock.type) === "cachePointBlock" ? { type: "ephemeral" } : void 0;
						systemBlocks.push({
							type: "text",
							text: block.text,
						...
						if (cacheControl) i++;
					} else if (block.type === "guardContentBlock") logger.warn("block_type=<guardContentBlock> | guard content not supported in anthropic system prompt | skipping");
				}
				if (systemBlocks.length > 0) request.system = systemBlocks;
			}
		}
		if ((_a2 = options == null ? void 0 : options.toolSpecs) == null ? void 0 : _a2.length) {
			...
			if (options.toolChoice) {
				if ("auto" in options.toolChoice) request.tool_choice = { type: "auto" };
				else if ("any" in options.toolChoice) request.tool_choice = { type: "any" };
		...
		if (this._config.temperature !== void 0) request.temperature = this._config.temperature;
		if (this._config.topP !== void 0) request.top_p = this._config.topP;
		if (this._config.stopSequences !== void 0) request.stop_sequences = this._config.stopSequences;
	...
	_formatMessages(messages) {
		return messages.map((msg) => {
			...
			for (let i = 0; i < msg.content.length; i++) {
				...
				const hasCachePoint = (nextBlock == null ? void 0 : nextBlock.type) === "cachePointBlock";
	...
	_formatContentBlock(block) {
		switch (block.type) {
			...
			case "imageBlock": {
				...
				switch (imgBlock.format) {
					...
					case "webp":
						...
						break;
					default: throw new Error(`Unsupported image format for Anthropic: ${imgBlock.format}`);
				}
				if (imgBlock.source.type === "imageSourceBytes") return {
					type: "image",
					source: {
						type: "base64",
			...
			case "documentBlock": {
				...
				if (docBlock.format === "pdf" && docBlock.source.type === "documentSourceBytes") return {
					type: "document",
					source: {
						type: "base64",
				...
				if (TEXT_FILE_FORMATS.includes(docBlock.format)) {
					let textContent;
					if (docBlock.source.type === "documentSourceText") textContent = docBlock.source.text;
					else if (docBlock.source.type === "documentSourceBytes") if (typeof TextDecoder !== "undefined") textContent = new TextDecoder().decode(docBlock.source.bytes);
					else logger.warn(`format=<${docBlock.format}> | cannot decode document bytes | TextDecoder not available`);
			...
			case "toolResultBlock": {
				const innerContent = block.content.map((c) => {
					if (c.type === "textBlock") return {
						type: "text",
						text: c.text
					};
					if (c.type === "jsonBlock") return {
						type: "text",
						text: JSON.stringify(c.json)
					};
					return this._formatContentBlock(c);
				}).filter((c) => !!c);
				let contentVal;
				const firstItem = innerContent[0];
				if (innerContent.length === 1 && firstItem && firstItem.type === "text") contentVal = firstItem.text;
				else contentVal = innerContent;
				return {
					type: "tool_result",
			...
			case "reasoningBlock":
				if (block.text && block.signature) return {
					type: "thinking",
					thinking: block.text,
					signature: block.signature
				};
				else if (block.redactedContent) return {
					type: "redacted_thinking",
					data: block.redactedContent
				};
				return;
			case "cachePointBlock": return;
			default: return;
		}
	}
